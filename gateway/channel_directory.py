...
# Reentrancy guard (ours, kept through the upstream merge): build_channel_directory has three
# trigger sites (startup, adapter connect, housekeeping) and the Slack web calls inside can be
# slow — an overlapping build just duplicates the work and thrashes DIRECTORY_PATH.
